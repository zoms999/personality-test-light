        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="border border-slate-200 rounded-lg p-3 max-h-40 overflow-y-auto text-xs text-slate-600 bg-slate-50 space-y-2 prose prose-xs prose-slate">
              ...
              {locale === 'ja' && (
                <>
                  <p className="font-semibold">【個人情報の収集および利用に関する同意書】</p>
                  <p><strong className="font-medium">収集項目:</strong> 氏名、生年月日、メールアドレス、性別、IPアドレス、User-Agent</p>
                  <p><strong className="font-medium">収集および利用目的:</strong><br/>
                  (1) 適性検査サービスの提供（個別最適化された検査結果、パーソナライズされたオンラインサービス）<br/>
                  (2) マーケティングおよびサービスサポート（サービス案内、イベント/プロモーション情報、個別最適化された広告/マーケティング資料の送付）<br/>
                  (3) 研究および開発（品質向上、サービス改善のためのデータ分析、新サービス/機能の研究）</p>
                  <p><strong className="font-medium">保有および利用期間:</strong><br/>
                  ・検査結果提供およびサービス支援/活用：収集日から5年間<br/>
                  ・研究および結果活用：10年間<br/>
                  （関連法令に基づく法定保存期間を遵守）</p>
                  <p><strong className="font-medium">提供および処理委託:</strong><br/>
                  原則として第三者への提供は行いません（法令に基づく場合、またはサービス運営のため外部業者へ業務委託する場合には事前に案内いたします）。</p>
                  <p><strong className="font-medium">法令遵守:</strong><br/>
                  個人情報保護法および関連法令を遵守します。</p>
                  <p><strong className="font-medium">同意拒否の権利および不利益:</strong><br/>
                  同意は任意です。ただし、同意されない場合、検査結果の提供など一部サービスの利用に制限が生じることがあります。</p>
                  <p><strong className="font-medium">破棄:</strong><br/>
                  保有期間満了または利用目的の達成後、速やかに破棄します。<br/>
                  （電子ファイル：完全削除、書面：裁断/焼却）</p>
                  <p><strong className="font-medium">お問い合わせおよび管理責任者:</strong><br/>
                  [パク・エステル] / +82-2-523-7523/ [admin@aptitude-x.com]</p>
                  <p className="italic">本同意書の内容を十分にお読みいただき、ご確認のうえ、同意をご選択ください。</p>
                </>
              )}
              {locale === 'vi' && (
                <>
